...
public final class ServerFrontEnd {
  ...
  private static final Logger.Log LOG = Logger.newLog(ServerFrontEnd.class);
  ...
  private static final Serializer<Relay.Bundle.ConversationComponent>
      CONVERSATION_COMPONENT_SERIALIZER =
      ...
      new Serializer<Relay.Bundle>() {
        ...
        public Relay.Bundle read(InputStream in) throws IOException {
          ...
          final Relay.Bundle.ConversationComponent conversation =
              CONVERSATION_COMPONENT_SERIALIZER.read(in);
  ...
  private void handleReadMessage(Connection connection) throws IOException {
    ...
    LOG.info("Reading team=%s root=%s range=%d", teamId, root, range);
  ...
  private void handleWriteMessage(Connection connection) throws IOException {
    ...
    final Relay.Bundle.ConversationComponent conversation =
        CONVERSATION_COMPONENT_SERIALIZER.read(connection.in());
    ...
    final boolean result = backEnd.write(teamId, teamSecret, user, conversation, message);
